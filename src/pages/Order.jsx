      ...
      <div className="bg-white shadow-2xl rounded-2xl p-10 w-full max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
          ...
          <input type="text" name="brandName" placeholder="Brand Name"
            required onChange={handleChange}
            className="border p-3 rounded-lg md:col-span-2 focus:ring-2 focus:ring-emerald-500" />
          ...
          <select name="shape" required onChange={handleChange}
            className="border p-3 rounded-lg focus:ring-2 focus:ring-emerald-500">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Logo will be shared manually on WhatsApp.
            </p>
          </div>

          <textarea name="information" placeholder="Additional Information"
